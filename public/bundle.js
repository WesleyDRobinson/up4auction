...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__routing_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__game_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_start_game_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_start_game_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_start_game_js__);


window.up4auction = Object(__WEBPACK_IMPORTED_MODULE_1__game_js__["a" /* default */])().actions
...
__WEBPACK_IMPORTED_MODULE_0__page_js__('*', transition)
__WEBPACK_IMPORTED_MODULE_0__page_js__('/', '/game')
__WEBPACK_IMPORTED_MODULE_0__page_js__('/game', startGame)
__WEBPACK_IMPORTED_MODULE_0__page_js__('/game/:id', (ctx) => {
    console.log('page: game/:id:', ctx)
})
__WEBPACK_IMPORTED_MODULE_0__page_js__()

window.page = __WEBPACK_IMPORTED_MODULE_0__page_js__
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = makeGame;
...
// functions
    ...
    const stageGame = (id) => {
        ...
        const _setCards = () => {
            ...
            let shuffledProps = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.shuffle(game.propertyCards)
            let shuffledMoneies = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.shuffle(game.moneyCards)
            while (n--) {
    ...
    const pass = (g, player) => {
        ...
        g.round.cards = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.difference(cards, [card])
    ...
    const selectAuctionCard = (g, player, cardId = p.propertyCards[0].id) => {
        let p = g.players.filter(el => (el.id === player.id))
        return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.remove(p.propertyCards, card => card.id === cardId)
    }
